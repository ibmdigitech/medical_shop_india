...
export default function ContactPage() {
  return (
    <>
      ...
      {/* Hero */}
      <section className="relative pt-32 pb-16 px-4 bg-gradient-to-b from-primary/5 via-white to-white dark:from-dark dark:to-dark-card overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="text-4xl md:text-6xl font-black text-gray-900 dark:text-white mb-6 leading-tight">
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.1 }}
              className="p-8 bg-white dark:bg-dark-card border border-gray-200 dark:border-dark-border rounded-3xl hover:border-primary transition-all shadow-lg">
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}
            className="lg:col-span-3 bg-white dark:bg-dark-card border border-gray-200 dark:border-dark-border rounded-[40px] p-8 md:p-12 relative overflow-hidden shadow-xl">
            <div className="absolute top-0 right-0 w-64 h-64 bg-primary/5 rounded-full blur-[100px]" />
            <div className="relative z-10">
              <h2 className="text-3xl font-black text-gray-900 dark:text-white mb-2">Send a <span className="text-primary">Message</span></h2>
              <p className="text-gray-600 dark:text-gray-400 mb-8">Have a specific requirement? Fill out the form below and we'll get back to you shortly.</p>
              <ContactForm />
            </div>
          </motion.div>
        </div>
