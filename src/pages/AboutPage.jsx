        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
             <div className="md:col-span-8 h-[400px] md:h-[600px] rounded-[40px] md:rounded-[60px] overflow-hidden border-8 border-white dark:border-white/5 shadow-2xl relative group">
                <img src="https://images.unsplash.com/photo-1587854692152-cbe660dbbb88?w=1200&auto=format" alt="Pharmacy" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
             ...
             <div className="md:col-span-4 grid grid-rows-2 gap-6">
                <div className="rounded-[40px] md:rounded-[50px] overflow-hidden border-8 border-white dark:border-white/5 shadow-2xl relative group">
                   <img src="https://images.unsplash.com/photo-1576091160550-2173ff9e5ee5?w=600&auto=format" alt="Medicines" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                </div>
