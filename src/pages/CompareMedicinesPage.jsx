...
export default function CompareMedicinesPage() {
  return (
    <>
      <Helmet>
        <title>Compare Medicine Prices - Medical Shope India</title>
                ...
                <div className="flex-1 w-full">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="p-5 rounded-2xl bg-white/5 border border-white/5">
                      ...
                      <p className="text-2xl font-black text-white/50 line-through">AED {item.brandedPrice}</p>
                    </div>
                    ...
                    <div className="p-5 rounded-2xl bg-primary/10 border border-primary/20 relative overflow-hidden group">
                      ...
                      <div className="flex items-end justify-between">
                        <p className="text-3xl font-black text-white">AED {item.genericPrice}</p>
